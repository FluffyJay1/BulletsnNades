...
namespace BulletsnNades
{
    class Level5 : State
    {
        ...
        public override void Create()
        {
            ...
            //DA FONT FOR DA BACKGROUND IS MACROPSIA BRK FONT SIZE 16
            base.Create();
            playerVelX = 0;
            playerVelY = 0;
            GameObject background = new GameObject("Level5Background", 3200, 600, "Level5Background.png");// <----------------------CHANGE THIS AS WELL
            ...
            /////////////////////////////////////////////////////////////////////////////
            PersistentData.Level = 5;
            playerPosX = 100;
            playerPosY = -550;
            new EnemyClass(750, -550, 50, 1);
            new EnemyClass(1025, -450, 50, 3);
            new EnemyClass(1075, -400, 50, 1);

            new EnemyClass(1350, -550, 50, 4);
            new EnemyClass(1600, -550, 50, 4);
            new EnemyClass(1800, -550, 50, 4);
            new EnemyClass(2440, -300, 50, 1);

            new EnemyClass(2500, -550, 50, 1);
            new EnemyClass(2675, -450, 50, 2);

            new MedKit(1225, -400);
            new MedKit(2525, -300);

            new PickUp(450, -475, "grenade4.png");
            new PickUp(1200, -400, "bullet4.png");
            new Finish(3000, -550);
