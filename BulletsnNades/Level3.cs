...
namespace BulletsnNades
{
    class Level3 : State
    {
        ...
        public override void Create()
        {
            ...
            playerVelX = 0;
            playerVelY = 0;
            GameObject background = new GameObject("Level3Background", 1200, 800, "Level3Background.png");// <----------------------CHANGE THIS AS WELL
            ...
            /////////////////////////////////////////////////////////////////////////////
            PersistentData.Level = 3;
            playerPosX = 75;
            playerPosY = -750;
            new EnemyClass(100, -550, 50, 2);
            new EnemyClass(800, -425, 50, 1);
            new EnemyClass(875, -525, 50, 1);
            new EnemyClass(550, -200, 50, 1);
            new EnemyClass(175, -350, 50, 3);
            new EnemyClass(325, -350, 50, 3);

            new MedKit(200, -550);

            new PickUp(650, -675, "bullet3.png");
            new Finish(125, -350);
