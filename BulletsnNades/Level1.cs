...
namespace BulletsnNades
{
    class Level1 : State
    {
        ...
        public override void Create()
        {
            ...
            playerVelX = 0;
            playerVelY = 0;
            GameObject background = new GameObject("Level1Background", 800, 600, "Level1Background.png");// <----------------------CHANGE THIS AS WELL
            ...
            playerPosX = 75;
            playerPosY = -550;
            new EnemyClass(375, -150, 50, 1);
            new EnemyClass(725, -450, 50, 1);

            new MedKit(450, -350);

            new PickUp(500, -350, "grenade2.png");
            new Finish(100, -200);
