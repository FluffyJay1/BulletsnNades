...
namespace BulletsnNades
{
    class Level4 : State
    {
        ...
        public override void Create()
        {
            ...
            playerVelX = 0;
            playerVelY = 0;
            GameObject background = new GameObject("Level4Background", 800, 1200, "Level4Background.png");// <----------------------CHANGE THIS AS WELL
            ...
            /////////////////////////////////////////////////////////////////////////////
            PersistentData.Level = 4;
            playerPosX = 75;
            playerPosY = -200;
            new EnemyClass(150, -500, 250, 1);
            new EnemyClass(75, -450, 250, 1);
            new EnemyClass(75, -975, 50, 1);
            new EnemyClass(500, -975, 50, 1);

            //new MedKit(200, -550);

            new PickUp(400, -200, "grenade3.png");
            new Finish(250, -1150);
