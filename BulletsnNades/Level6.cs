...
namespace BulletsnNades
{
    class Level6 : State
    {
        ...
        public override void Create()
        {
            ...
            playerVelX = 0;
            playerVelY = 0;
            GameObject background = new GameObject("Level6Background", 1200, 800, "Level6Background.png");// <----------------------CHANGE THIS AS WELL
            ...
            /////////////////////////////////////////////////////////////////////////////
            PersistentData.Level = 6;
            playerPosX = 75;
            playerPosY = -750;
            new EnemyClass(175, -550, 50, 4);
            new EnemyClass(425, -550, 50, 4);
            new EnemyClass(175, -400, 50, 4);
            new EnemyClass(425, -400, 50, 4);
            new EnemyClass(175, -250, 50, 4);
            new EnemyClass(425, -250, 50, 4);

            new EnemyClass(825, -600, 50, 1);
            new EnemyClass(925, -600, 50, 4);
            new EnemyClass(1025, -600, 50, 1);
            new EnemyClass(1125, -600, 50, 4);
